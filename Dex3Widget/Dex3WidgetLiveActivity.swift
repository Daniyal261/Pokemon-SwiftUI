...
struct Dex3WidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = Dex3WidgetAttributes(name: "Me")
    static let contentState = Dex3WidgetAttributes.ContentState(value: 3)
